...
Alfinal he vuelto a hacer la páguina web para ordenarlo por carpetas, copie el mismo archivo CSS dentro de CSS y en Public, porque desde public no se me enlaza si es una carpeta que está fuera. Sigo teniendo problema para conseguir el enlace a la página web.
